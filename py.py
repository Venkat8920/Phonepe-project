...
icon = Image.open("PhonePe-Emblem.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Venkat",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Venkat*!
...
conn = pymysql.connect(host='127.0.0.1', user='root', password='Venkat1585#',port=3306, db='phonepe_pulses')
cursor = conn.cursor()
...
if selected == "Top Charts":
    ...
    colum1,colum2= st.columns([1,1.8],gap="large")
    with colum1:
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r'/Users/venkat/Documents/Project 2 new/Statenames.csv')
            df1.State = df2
